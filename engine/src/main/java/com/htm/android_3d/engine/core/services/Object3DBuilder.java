package com.htm.android_3d.engine.core.services;
...
import com.htm.android_3d.engine.core.services.collada.entities.Joint;
import com.htm.android_3d.engine.core.services.wavefront.WavefrontLoader;
import com.htm.android_3d.engine.core.services.wavefront.WavefrontLoader.FaceMaterials;
import com.htm.android_3d.engine.core.services.wavefront.WavefrontLoader.Faces;
import com.htm.android_3d.engine.core.services.wavefront.WavefrontLoader.Material;
import com.htm.android_3d.engine.core.services.wavefront.WavefrontLoader.Materials;
import com.htm.android_3d.engine.core.services.wavefront.WavefrontLoader.Tuple3;
import com.htm.android_3d.engine.util.android.ContentUtils;
import com.htm.android_3d.engine.util.math.Math3DUtils;
...
public final class Object3DBuilder {
	...
	public static Object3DData buildPoint(float[] point) {
		return new Object3DData(createNativeByteBuffer(point.length * 4).asFloatBuffer().put(point))
				.setDrawMode(GLES32.GL_POINTS).setId("Point");
	}
	...
	public static Object3DData buildLine(float[] line) {
		return new Object3DData(createNativeByteBuffer(line.length * 4).asFloatBuffer().put(line))
				.setDrawMode(GLES32.GL_LINES).setId("Line").setFaces(new Faces(0));
	}
	...
	public static Object3DData buildAxis() {
		return new Object3DData(
				...
				.setDrawMode(GLES32.GL_LINES).setFaces(new Faces(0));
	}
	...
	public static Object3DData buildCubeV1() {
		return new Object3DData(
				...
				.setDrawMode(GLES32.GL_TRIANGLES).setId("cubeV1").centerAndScale(1.0f).setFaces(new Faces(8));
	}
	...
	public static Object3DData buildCubeV1_with_normals() {
		return new Object3DData(
				...
				.setDrawMode(GLES32.GL_TRIANGLES).setId("cubeV1_light").centerAndScale(1.0f).setFaces(new Faces(8));
	}
	...
	public static Object3DData buildSquareV2() {
		...
		return new Object3DData(vertexBuffer,drawBuffer.asReadOnlyBuffer()).setDrawMode(GLES32.GL_TRIANGLES).setId("cubeV2")
	...
	public static Object3DData buildCubeV3(byte[] textureData) {
		return new Object3DData(
				...
				textureData).setDrawMode(GLES32.GL_TRIANGLES).setId("cubeV3").centerAndScale(1.0f).setFaces(new Faces(8));
	}
	...
	public static Object3DData buildCubeV4(byte[] textureData) {
		return new Object3DData(
				...
				createNativeByteBuffer(cubeTextureCoordinateData.length * 4).asFloatBuffer()
						.put(cubeTextureCoordinateData).asReadOnlyBuffer(),
				textureData).setDrawMode(GLES32.GL_TRIANGLES).setId("cubeV4").centerAndScale(1.0f).setFaces(new Faces(8));
	}
	...
	public static Object3DData loadV5(Activity activity, Uri modelUri) {
		try {
			...
			data3D.setDrawMode(GLES32.GL_TRIANGLES);
			...
			try {
				...
				if (objData instanceof AnimatedModel){
					...
					object3DData.setVertexBuffer(objData.getVertexBuffer()).setDrawOrder(wireframeDrawOrder).
							...
							.setDrawMode(GLES32.GL_LINES).setDrawUsingArrays(false);
	...
	public static Object3DData buildFaceNormals(Object3DData obj) {
		if (obj.getDrawMode() != GLES32.GL_TRIANGLES) {
			return null;
		}
		...
		return new Object3DData(normalsLines).setDrawMode(GLES32.GL_LINES).setColor(obj.getColor())
	...
	public static AnimatedModel buildSkeleton(AnimatedModel animatedModel){
        ...
        skeleton.setVertexNormalsArrayBuffer(createNativeByteBuffer(animatedModel.getJointCount()*3*3*4)
                .asFloatBuffer());
        skeleton.setDrawMode(GLES32.GL_TRIANGLES);
