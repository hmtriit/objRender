...
import com.htm.android_3d.engine.core.collision.Octree;
...
public class Object3DData {
	 ...
	 */
	private int drawMode = GLES32.GL_POINTS;
	...
	private int drawOrderBufferType = GLES32.GL_UNSIGNED_INT;
	...
	private int textureWrapS = GLES32.GL_REPEAT;
	private int textureWrapT = GLES32.GL_REPEAT;
	private int textureMinFilter = GLES32.GL_NEAREST;
	private int textureMagFilter = GLES32.GL_NEAREST;
	...
	private int emissiveTextureWrapS = GLES32.GL_REPEAT;
	private int emissiveTextureWrapT = GLES32.GL_REPEAT;
	private int emissiveTextureMinFilter = GLES32.GL_NEAREST;
	private int emissiveTextureMagFilter = GLES32.GL_NEAREST;
	// derived data
	...
	public Object3DData centerAndScaleAndExplode(float maxSize, float explodeFactor) {
		if (drawMode != GLES32.GL_TRIANGLES) {
