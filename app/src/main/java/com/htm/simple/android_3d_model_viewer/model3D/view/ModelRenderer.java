package com.htm.simple.android_3d_model_viewer.model3D.view;
...
import com.htm.android_3d.engine.core.animation.Animator;
import com.htm.android_3d.engine.core.drawer.DrawerFactory;
import com.htm.android_3d.engine.core.model.AnimatedModel;
import com.htm.android_3d.engine.core.model.Camera;
import com.htm.android_3d.engine.core.model.Object3D;
import com.htm.android_3d.engine.core.model.Object3DData;
import com.htm.android_3d.engine.core.services.Object3DBuilder;
import com.htm.simple.android_3d_model_viewer.model3D.demo.SceneLoader;
...
public class ModelRenderer implements GLSurfaceView.Renderer {
	...
	public void onSurfaceCreated(GL10 unused, EGLConfig config) {
		...
		GLES32.glClearColor(backgroundColor[0], backgroundColor[1], backgroundColor[2], backgroundColor[3]);
		...
		// GLES32 not drawing out of view port
	...
	public void onDrawFrame(GL10 unused) {
		...
		try {
			...
			GLES32.glViewport(0, 0, width, height);
			GLES32.glScissor(0, 0, width, height);
			...
			if (scene.isVRGlasses()) {
				...
				GLES32.glScissor(0, 0, width / 2, height);
				this.onDrawFrame(viewMatrixLeft, projectionMatrixLeft, viewProjectionMatrixLeft, lightPosInEyeSpace,
						null);

				// draw right eye image
				GLES32.glViewport(width / 2, 0, width / 2, height);
				GLES32.glScissor(width / 2, 0, width / 2, height);
				this.onDrawFrame(viewMatrixRight, projectionMatrixRight, viewProjectionMatrixRight, lightPosInEyeSpace,
						null);
			}
		}catch (Exception ex){
...
//				}
				...
				// draw points
				if (objData.getDrawMode() == GLES32.GL_POINTS){
					Object3D basicDrawer = drawer.getPointDrawer();
					basicDrawer.draw(objData, projectionMatrix, viewMatrix, GLES32.GL_POINTS,lightPosInEyeSpace);
				}

				// draw wireframe
				else if (scene.isDrawWireframe() && objData.getDrawMode() != GLES32.GL_POINTS
						&& objData.getDrawMode() != GLES32.GL_LINES && objData.getDrawMode() != GLES32.GL_LINE_STRIP
						&& objData.getDrawMode() != GLES32.GL_LINE_LOOP) {
				...
				// draw points
						...
						drawerObject.draw(objData, projectionMatrix, viewMatrix
								, GLES32.GL_POINTS, objData.getDrawSize(),
