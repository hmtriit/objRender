...
import com.htm.android_3d.engine.util.android.AndroidUtils;
import com.htm.android_3d.engine.util.android.AssetUtils;
import com.htm.android_3d.engine.util.android.ContentUtils;
import com.htm.android_3d.engine.util.android.FileUtils;
import com.htm.simple.android_3d_model_viewer.R;
import com.htm.simple.android_3d_model_viewer.view.TextActivity;
...
public class MenuActivity extends ListActivity {
    ...
    private static final String REPO_URL = "https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/model-index.json";
    ...
    private static final String SUPPORTED_FILE_TYPES_REGEX = "(?i).*\\.(obj|mtl|stl|dae|gltf|index)";
        ...
        try {
            switch (action) {
                case DEMO:
                    ...
                    break;
                case GITHUB:
                    AndroidUtils.openUrl(this, REPO_URL);
                    break;
                case LOAD_MODEL:
                    loadModel();
                    break;
